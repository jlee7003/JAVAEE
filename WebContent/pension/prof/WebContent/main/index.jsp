...
<%@ page language="java" contentType="text/html; charset=utf-8"
 ...
 <style>
  ...
  <div id=post>
   ...
   <table width=290 height=290 align=center>
     <tr> 
       <td> 여름맞이 이벤트 </td>
     </tr>
     <tr>
       <td id=aa> 기간 : 2019년 6월 30일 ~ 2019년 8월 31일 </td>
     </tr>
     <tr>
       <td id=bb> 내용 : 전 숙박고객에게 BBQ 제공 </td>
     </tr>
     <tr>
       <td align=center id=cc>
  ...
  <script>
   function change_form()
   {
	   ...
	   document.all.bb.innerHTML="전화번호  <input type=text name=phone>";
	   document.all.cc.innerHTML="<input type=submit value=저장>"
   }
  </script>
  <style>
   #post {
