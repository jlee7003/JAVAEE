...
<script src="../etc/main.js?after"></script>
<!-- daum 도로명주소검색 API 시작 -->
...
<td><input type=password name=pwd1 class=in1 onblur=check_len(this)>
<div id=pkc3></div>
</td>
</tr>
<tr>
...
<td><input type=text name=pwd_ class=in1></td>
</tr>
<tr>
<td class=td1>이름</td>
<td><input type=text name= class=in1></td>
</tr>
<tr>
<td class=td1>주소</td>
