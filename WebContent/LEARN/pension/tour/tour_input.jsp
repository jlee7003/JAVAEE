...
<div id=left>
		...
		<div id=right>
   <h2>여행 후기</h2>
   <form method=post action=tour_inputok.jsp enctype=multipart/form-data>
   작성자: <input type=text name=name><p>
   제목: <input type=text name=title size=50><p>
   내용 : <textarea cols=50 rows=4 name=content> </textarea> <p>
 그림: <input type=file name=fname><p>
