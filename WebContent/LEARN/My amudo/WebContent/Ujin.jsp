...
<%
   Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3307/pension?useSSL=false", "root",
         "1234");
...
<script>
   ...
   function autoCheck() {
      document.form.sex<%=rs.getInt("sung")%>].checked = true;
      document.form.age.value = <%=rs.getString("sung")%>
   }
</script>
</head>
