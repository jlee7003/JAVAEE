...
<body>
  ...
  <div id=right>
    <section class=member_section>
     ...
     <table width=800 border=0> <!-- 회원구분있는 첫번째 테이블 -->
      <tr>
       <td class=td1> 회원구분 </td>
       <td> <input type=radio name=mem value=1 checked>개인회원 </td>
      </tr>
     </table>
     ...
     <table width=800 border=0>  <!-- 회원정보 입력칸이 있는 두번째 테이블 -->
       ...
       <tr>
        ...
        <td> <input type=text name=pwd1 class=in1 onblur=check_len(this)> (영문대소문자/숫자, 4자~16자)</td>
       </tr> 
       <tr>
       ...
       <tr>
        ...
        <td> <input type=text name=pwd_ans class=in1> </td>
       </tr> 
       <tr>
        <td class=td1> 이름* </td>
     ...
     <table width=800 border=0>
      ...
      <tr>
       <td> 
         ...
         이용약관에 동의하십니까? <input type=checkbox name=chk1 value=1>동의함
       </td>
      </tr>
      <tr>
       <td> 
       ...
       <textarea cols=90 rows=9><jsp:include page="second.txt"/>
        ...
        개인정보 수집 및 이용에 동의하십니까?<input type=checkbox name=chk2 value=1>동의함
       </td>
      </tr>
      <tr>
       <td> 
        [선택]쇼핑정보 수신 동의 <p>
        <textarea cols=90 rows=9><jsp:include page="third.txt"/>
         </textarea> <p>
        SMS수신을 동의하십니까? <input type=checkbox name=chk3 value=1>동의함<p>
        이메일 수신을 동의하십니까? <input type=checkbox name=chk4 value=1>동의함
       </td>
      </tr>
     </table>
     </form>
