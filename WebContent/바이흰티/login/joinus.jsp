...
.j3{
height:120px;
    border: 10px 1px 1px 0px solid #dfdfdf;
   border:1px solid #dfdfdf;
width:100%;
display:flex;
}
...
<hr>
<div class=j1>
<div class=jj1>회원구분<b style="color:orange">*</b></div>
<div class=jj2><input type=radio>개인회원</div>
</div>
<div class=flex>
<div id=q1  align=left>기본정보</div>
<div id=q2><b style="color:orange">*</b>필수입력사항</div>
</div>
<div class=j2>
<div class=jj1>아이디<b style="color:orange">*</b></div>
<div class=jj2><input type=text> </div>
</div>
<div class=j2>
<div class=jj1>비밀번호<b style="color:orange">*</b></div>
<div class=jj2><input type=password></div>
</div>
<div class=j2>
<div class=jj1>비밀번호 확인<b style="color:orange">*</b></div>
<div class=jj2><input type=password></div>
</div>
<div class=j2>
<div class=jj1>비밀번호 확인 질문<b style="color:orange">*</b></div>
<div class=jj2>
<select >
<option>기억에 남는 추억의 장소는?</option>
<option>자신의 인생 좌우명은?</option>
<option>자신의 보물 제 1호는?</option>
<option>가장 기억에 남는 선생님의 성함은?</option>
...
<option>자신이 두번째로 존경하는 이물은?</option>
<option>친구들에게 공개하지 않은 어릴 적 별명이 있다면?</option>
<option>초등학교 때 기억에 남는 짝궁의 이름은?</option>
...
<div class=j2>
<div class=jj1>비밀번호 확인 답변<b style="color:orange">*</b></div>
<div class=jj2><input type=text></div>
</div>
<div class=j2>
<div class=jj1>이름<b style="color:orange">*</b></div>
<div class=jj2><input type=text name=userid></div>
</div>
<div class=j3>
<div class=jj3>주소<b style="color:orange">*</b></div>
<div class=jj4><input type=text size=4 name=juso1><input type=button value="우편번호 >"><p>
<input type=text name=juso2> 기본주소<p>
<input type=text name=juso3> 나머지주소
...
<div class=j2>
<div class=jj1>생년 월일</div>
<div class=jj2><input type=text maxlength=4 size=6>년 <input type=text maxlength=2 size=1>월 <input type=text maxlength=2 size=1 >일 </div>
</div>
...
<div class=agreebox>
<div><input type=checkbox style="width:25px;height:25px;margin-bottom:50px;">이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</div>
<div> [필수] 이용 약관 동의</div>
<div></div>
<div align=center>
<div style="overflow-y:scroll; width:95%; height:150px;" align=left>
<pre>
제0조 카카오 알림톡 시행에 관한 내용



"바이흰티 쇼핑몰"은 회원가입.주문안내.배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며,만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자 메시지로 보내드립니다. 카카오 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할경우, 


알림톡 수신중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다. 
...
① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다. 
...
② "몰"은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각호에 해당하지 않는 한 회원으로 등록합니다. 1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에 의한 회원자격 상실후 3년이 경과한 자로서 "몰"의 회원재가입 승낙을 얻은 경우에는 예외로 한다. 2. 등록 내용에 허위, 기재누락, 오기가 있는 경우 3. 기타 회원으로 등록하는 것이 "몰"의 기술상 현저히 지장이 있다고 판단되는 경우 
...
#카카오 알림톡 시행에관한 내용
"바이흰티 쇼핑몰"은 회원가입.주문안내.배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며,만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자 메시지로 보내드립니다. 카카오 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할경우, 알림톡 수신중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다. 
...
“바이흰티는 회원가입, 주문안내, 배송안내 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자메시지로 보내드립니다. 카카오톡 알림톡을 통해 안내되는 정보를 와이파이가 아닌 이동통신망으로 이용할 경우, 알림톡 수신 중 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 발송되는 알림톡 수신을 원치 않으실 경우 반드시 알림톡을 차단하여 주시기 바랍니다.
...
바이흰티는 상담업무를 카카오톡 상담톡으로 진행하며, 만약 카카오톡을 통해 안내되는 상담 내용을 Wi-Fi 나 PC가 아닌 이동통신망으로 이용할 경우, 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 상담을 원치 않으실 경우 고객센터, 게시판 문의를 이용해 주시기 바랍니다.
...
바이흰티는 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다. 바이흰티는 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.
...
<div style="font-size:12px;">이용약관에 동의하십니까? <input type=checkbox>동의함</div>
<!-- --------------------------------------- -->
<div style="margin-top:30px;"> [필수] 개인정보 수집 및 이용 동의</div>
<div></div>
<div align=center>
<div style="overflow:auto; width:95%; height:150px;" align=left>
<pre>

#개인정보의 위탁처리
바이흰티 쇼핑몰은 서비스 향상을 위해 관계법령에 따라 회원님들의 동의를 얻거나 관련 사항을 공개 또는 고지후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다.
바이흰티 쇼핑몰의 개인정보처리 수탁자의 그업무의 내용은 다음과 같습니다

-수탁자:(주)루나소프트
-위탁업무 내용: 카카오 알림톡 발송 업무

 -보존기간:5년
*소비자 불만 또는 분쟁처리에 관한기록
-보존기간: 3년
*로그 기록
-보존이유: 통신비밀보호범
-보존기간: 3개월
...
<div align=center><input type=button value="회원가입" style="width:100px; height:50px;"></div>
</div><!-- ------------------------------------------------------ -->
</body>
</html>